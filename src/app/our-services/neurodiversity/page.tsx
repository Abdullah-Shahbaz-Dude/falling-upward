...
function ADHDCoachingContent() {
  ...
  const packages = [
    {
      ...
      description:
        "A highly interactive session designed to shift mindsets and bust myths.",
      features: [
    ...
    },
    {
      ...
      description:
        "For startups and growth-phase businesses ready to unlock team potential.",
      features: [
    ...
    },
    {
      ...
      description:
        "Ideal for forward-thinking organisations, incubators, or VCs.",
      features: [
  ...
  const challenges = [
    ...
    {
      text: "Do you frequently start tasks but abandon them halfway through?",
      icon: FiActivity,
    },
    {
      text: "Do you find it hard to relax or feel mentally exhausted all the time?",
      icon: FiZap,
    },
    {
      text: "Do you experience brain fog and struggle to think clearly?",
      icon: FiEye,
    },
    {
      text: "Are mornings difficult, leaving you groggy and unmotivated?",
      icon: FiCalendar,
    },
    {
      text: "Do you have trouble maintaining a consistent routine with diet, exercise, or self-care?",
      icon: FiHeart,
    },
    {
      text: "Do you feel overly sensitive to criticism or fear rejection?",
      icon: FiShield,
    },
    {
      text: "Do you seek reassurance from others but struggle to trust your own decisions?",
      icon: FiUsers,
    },
    {
      text: "Do you overcomplicate things, making it hard to follow through on your goals?",
      icon: FiCpu,
    },
    {
      text: "Are you easily distracted by noise, visual stimuli, or your environment?",
      icon: FiBarChart2,
    },
    {
      text: "Do you find it difficult to set and maintain personal boundaries?",
      icon: FiTarget,
    },
    {
      text: "Do you struggle with emotional regulation, feeling intense highs and lows?",
      icon: FiTrendingUp,
    },
    {
      text: "Feel shame as you think you do not fit in and repeat cycles?",
      icon: FiSmile,
    },
    {
      text: "Do you analyse every interaction, worrying about how others perceive you?",
      icon: FiMessageCircle,
    },
    { text: "Do you often procrastinate?", icon: FiChevronRight },
    {
      text: "Have you felt stuck in unhealthy relationships, struggling to move on?",
      icon: FiHeart,
    },
    {
      text: "Do you find you are overly sensitive to rejection?",
      icon: FiShield,
    },
  ];
  ...
  const coachingApproach = [
    ...
    {
      title: "Develop Systems & Routines That Work for You",
      description:
        "Learn how to set up realistic routines that help you stay on track without feeling overwhelmed.",
    },
    {
      title: "Improve Emotional Regulation & Resilience",
      description:
  ...
  const neuroDiversityAdvantages = [
    {
      ...
      description:
        "Less influenced by group norms or 'how it's always been done'",
    },
    {
      title: "Creative insight",
      description:
        "Driven by hyperfocus, lateral thinking, and deep special interests",
    },
    {
      ...
      <div className="mb-0">
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div
              className={`p-4 rounded-full mb-4 ${
                activeSection === "individual" ? "bg-white/20" : "bg-[#D6E2EA]"
              }`}
            >
              <FiUsers
                className={`w-8 h-8 ${
          ...
          >
            <div
              className={`p-4 rounded-full mb-4 ${
                activeSection === "business" ? "bg-white/20" : "bg-[#D6E2EA]"
              }`}
            >
              <FiBriefcase
                className={`w-8 h-8 ${
                  activeSection === "business" ? "text-white" : "text-[#0B4073]"
                }`}
              />
            </div>
            ...
            <p
              className={`text-sm ${
                activeSection === "business" ? "text-white/80" : "text-gray-600"
              }`}
            >
  ...
  What You Can Expect to Achieve
          ...
          <div className="business-neurodiversity-content mt-20 mb-0 ">
            {/* Introduction Section */}
            <div className="bg-[#D7E3F3] rounded-xl p-8 pb-20">
              <h3 className="text-5xl font-bold text-center  pt-8  text-[#0B4073] mb-16">
              ...
              <div className="bg-white rounded-2xl p-12 space-y-10 max-w-6xl mx-auto">
                {neurodiversity.map((outcome, index) => (
                  <div
                    key={index}
                    className="flex justify-between items-start border-b last:border-b-0 pb-7"
                  >
            ...
            <section className="py-20 px-5 bg-white pt-0">
              <div className="container mx-auto px-6">
                <h2 className="text-5xl font-bold text-center pt-16 text-[#0B4073] mb-16 ">
            ...
            <div className="bg-[#D7E3F3] py-16 px-6  pb-20">
              <h3 className="text-5xl font-bold text-center text-[#0B4073] mb-16">
              ...
              <div className="flex flex-col lg:flex-row justify-center items-center gap-12">
                ...
                <div className="space-y-6 w-full lg:w-1/2 max-w-md">
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition duration-300">
                    <h4 className="text-xl font-semibold text-[#0B4073]">
                      Psychology
                    </h4>
                    <p className="text-sm text-gray-700 mt-2">
                      Understanding how neurodiverse brains process, create, and
                      relate.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition duration-300">
                    ...
                    <p className="text-sm text-gray-700 mt-2">
                      Breaking down assumptions and rebuilding new mental models
                      from the ground up.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition duration-300">
                    ...
                    <p className="text-sm text-gray-700 mt-2">
                      Delivering coaching and transformation in business
                      environments.
                    </p>
                  </div>
                </div>
            ...
            <div className="w-full bg-white py-20 px-6">
              <div className="max-w-7xl mx-auto text-center">
                <h2 className="text-5xl font-bold text-center text-[#0B4073] mb-16">
                  Packages Offered:
                </h2>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10 px-14">
                  {packages.map((pkg, index) => (
                    <div
                      key={index}
                      className="rounded-2xl border border-gray-200 shadow-md hover:shadow-xl  duration-300 bg-white p-6 flex flex-col justify-between hover:scale-[1.02] transform transition-all ease-in-out"
                    >
                      <div>
                        <h3
                          className={`text-xl font-semibold mb-3 leading-snug  ${pkg.textColor}`}
                        >
                          {pkg.title}
                        </h3>
            ...
            <div className="bg-[#D6E2EA] py-12 pb-0 md:py-16 lg:py-20 md-0 h-[500px] ">
              <div className="container mx-auto text-center md-0 ">
                <h2 className="text-5xl font-bold text-center text-[#0B4073] mb-16">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 lg:gap-16">
                  ...
                  <div className="hidden md:block text-[#0B4073] text-5xl">
                    &rarr;
                  </div>
                  <div className="flex flex-col items-center">
                    <div className="text-blue-500 text-5xl mb-2">
