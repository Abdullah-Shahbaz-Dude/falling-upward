...
import { FiArrowLeft, FiArrowRight,  FiCpu, FiHeart, FiStar, FiUsers } from 'react-icons/fi';
import {  FiBriefcase } from 'react-icons/fi';
import { HeroSection } from '@/components/HeroSection';
import { motion } from "framer-motion";
import { Lightbulb, Users, BarChart2, Link2, ClipboardCheck, Brain, LinkIcon } from "lucide-react";
...
const approachSections = [
  
  {
    ...
    icon: <Image src="/favicon.ico" alt="Neurodiversity" width={32} height={32} />,
    description: ["Many organisations overlook the 	strategic advantage that comes from diverse cognitive styles. We 	provide training and advisory support to help leadership teams:",
  ...
  },
  {
    ...
    icon: <Image src="/favicon.ico" alt="Neurodiversity" width={32} height={32} />,
    description: ["Boards function best when open 	dialogue and constructive challenge are embedded into 	decision-making. We help leadership teams create a psychologically 	safe environment, ensuring that all perspectives are heard."],
    reversed: true,
  ...
  },
  {
    ...
    icon: <Image src="/favicon.ico" alt="Neurodiversity" width={32} height={32} />,
    description:  "Cognitive biases can silence 	innovation, reinforce outdated strategies, and limit organisational 	growth. We equip boards with tools to identify and mitigate 	unconscious bias, leading to more balanced, inclusive, and effective 	strategic choices.",
    reversed: false,
  ...
  },
  {
    ...
    icon: <Image src="/favicon.ico" alt="Neurodiversity" width={32} height={32} />,
    description: "Boards set the direction, but real change happens when leaders and employees move forward together. We help leadership teams align strategy with workforce psychology, ensuring that boardroom decisions resonate across all levels of the organisation.",
    reversed: false,
  ...
  },
  {
    title: "Harnessing Neurodiversity for Strategic Change",
    icon: <Image src="/favicon.ico" alt="Neurodiversity" width={32} height={32} />,
    description: "We train leadership teams to recognise and leverage neurodivergent strengths, foster inclusive boardroom cultures, and unlock innovation through diverse cognitive styles.",
    reversed: true,
...
const offerings = [
  {
    ...
    description: "Executives and Senior Leaders wanting space to reflect and refine their leadership style.",
    bgColor: "bg-blue-50"
  },
  {
    title: "Founders & Entrepreneurs",
    description: "Founders & Entrepreneurs navigating growth, funding pressures, or team dynamics.",
    bgColor: "bg-indigo-50"
  },
  {
    title: "Managers stepping into bigger roles",
    description: "Managers 	stepping into bigger roles who 	want to lead with clarity and emotional intelligence.",
    bgColor: "bg-purple-50"
  },
  {
    title: "Professionals feeling stuck",
    description: "Professionals 	feeling stuck in 	high-functioning roles but not thriving beneath the surface.",
    bgColor: "bg-teal-50"
  }
];
...
export default function ExecutiveMentoringPage() {
  ...
  return (
      ...
      <div className="mb-0">
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div
              className={`p-4 rounded-full mb-4 ${
                activeSection === 'Mentoring ' ? 'bg-white/20' : 'bg-[#D6E2EA]'
              }`}
            >
              <FiUsers
                className={`w-8 h-8 ${
          ...
          >
            <div
              className={`p-4 rounded-full mb-4 ${
                activeSection === 'Boardroom' ? 'bg-white/20' : 'bg-[#D6E2EA]'
              }`}
            >
              <FiBriefcase
                className={`w-8 h-8 ${
    ...
    <span className="font-semibold text-[#0B4073]"> strategic thinking</span>, 
    <span className="font-semibold text-[#0B4073]"> first principles problem-solving</span>, 
    and 
    <span className="font-semibold text-[#0B4073]"> applied psychology </span> 
     to support you in making lasting progress, professionally and personally.
  </p>
        </div>
    ...
    {offers.map((item, index) => (
      <React.Fragment key={index}>
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-center text-[#0B4073] mb-16">Who It’s For</h2>
  ...
  <div className="max-w-screen-xl mx-auto px-4 md:px-10 flex flex-col md:flex-row items-center justify-center md:justify-between gap-12 rounded-md">
    ...
    <div className="w-full md:w-1/2 text-white text-center md:text-left">
      ...
      <p className="text-lg md:text-xl leading-relaxed">
        True leadership excellence isn’t just about processes and expertise — it’s about people,
        behaviour, and decision-making at the highest levels. Boards shape the direction of an
        organisation, but fear, bias, and resistance to challenge can often limit progress.
        <br /><br />
        We use organisational and business psychology to help leadership teams create high-performing
        boards. By understanding how different personalities, cognitive styles, and biases influence
        boardroom dynamics, we help leaders create an open, high-performance culture where decisions
        are informed, inclusive, and strategically sound.
      </p>
    </div>
    ...
    <h2 className="text-4xl font-bold text-center text-[#0B4073] mb-16">Our Approach</h2>
    <div className="space-y-16 px-10">
      {approachSections.map((section, idx) => (
        <motion.div
          ...
          className="transition-all duration-300"
        >
          <div className={`flex flex-col ${section.reversed ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 items-center`}>
            <div className="flex-1">
              <div className="bg-white shadow-sm rounded-xl p-8 hover:shadow-lg transition-shadow duration-300 border border-[#D6E2EA]">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-semibold text-[#0B4073]">{section.title}</h3>
                </div>
       ...
       <section className="relative py-20 md:py-24 mt-20 " >
        ...
        <div className="flex flex-row items-center container-custom mx-auto relative z-10">
          {/* Left Side (Text) */}
          ...
          <div className="flex flex-col space-y-6 max-w-2xl mx-auto md:ml-10">
            {[
              ...
              >
                <div className="bg-[#0B4073]/90 backdrop-blur-sm hover:bg-[#0B4073] text-white rounded-full py-5 px-8 flex items-center justify-between transition-all duration-300 w-full">
                  <span className="font-medium text-lg">{title}</span>
                  <div className="bg-[#D6E2EA] rounded-full p-3 ml-4 text-[#0B4073] group-hover:bg-[#D6E2EA]/90 transition-all">
