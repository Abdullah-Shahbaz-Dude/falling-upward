      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        ...
        <div className="bg-white rounded-xl shadow-md p-8 mb-16">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-[#0B4073] mb-2">
              Why Choose Falling Upward
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">
                Every client receives a tailored experience designed for their
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">
                Our team brings decades of experience and specialized training
            ...
            <div className="text-center p-4">
              ...
              <p className="text-gray-600">
                Our methodologies have helped hundreds of clients achieve
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <div className="space-y-6 max-w-4xl mx-auto">
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600">
                Simply come as you are. There's no need for extensive
                preparation, though you may want to reflect on your goals for
                the session. We'll guide the process and ensure you feel
                comfortable.
              </p>
            </div>
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600">
                Most consultations last 50-60 minutes, though some specialized
                services may have different durations. The specific details will
                be confirmed when scheduling your appointment.
              </p>
            </div>
            ...
            <div className="border-b border-gray-200 pb-4">
              ...
              <p className="text-gray-600">
                Yes, we understand circumstances change. We ask for at least 24
                hours' notice for cancellations or rescheduling to avoid any
                cancellation fees.
              </p>
            </div>
          </div>
