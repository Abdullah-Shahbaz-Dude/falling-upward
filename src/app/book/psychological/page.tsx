...
import { FiArrowLeft, FiCalendar, FiCheck, FiMail, FiMessageSquare, FiPhone, FiUser } from 'react-icons/fi';
...
const bookingSchema = z.object({
  ...
  therapyAgreement: z.boolean().refine((val) => val === true, {
    message: "You must agree to engage in psychological therapy",
  }),
...
function BookPageContent() {
  ...
  const therapyTypes = [
    ...
    { value: 'walking', label: 'Walking Therapy' },
  ...
  const onSubmit = async (data: BookingFormValues) => {
    ...
    try {
      ...
      const therapyTypeLabel = data.therapyType === 'walking' 
        ? 'Walking Therapy' 
      ...
      setSuccess(`Your ${therapyTypeLabel} consultation has been booked successfully!`);
      reset();
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <label htmlFor="postcode" className="block mb-2 text-sm font-medium text-gray-700">
                        Postcode
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                ...
                <div>
                  ...
                  <div>
                    <label htmlFor="gpInfo" className="block mb-2 text-sm font-medium text-gray-700">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label htmlFor="currentWellbeing" className="block mb-2 text-sm font-medium text-gray-700">
                    ...
                    <div>
                      <label htmlFor="therapyReason" className="block mb-2 text-sm font-medium text-gray-700">
