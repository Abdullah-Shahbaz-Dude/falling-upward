...
import { FiArrowRight, FiCheck, FiUsers, FiAward, FiActivity, FiMail, FiPhone, FiHeart, FiBriefcase, FiStar, FiCpu, FiChevronDown, FiChevronUp, FiChevronLeft, FiChevronRight, FiCalendar } from 'react-icons/fi';
...
function TestimonialSlider() {
  ...
  const testimonials = [
    ...
    {
      id: 6,
      quote: "Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores.",
      name: "Shari Gutmann",
      ...
      <div className="flex flex-col items-center">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          {visibleTestimonials.map((testimonial) => (
            <div key={testimonial.id} className="bg-white rounded-lg shadow-lg p-6 flex flex-col">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium text-[#6A8EA0]">{testimonial.name}</h4>
...
function AccordionItem({ title, content, isOpen = false }: { title: string, content: React.ReactNode, isOpen?: boolean }) {
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const initialZoomTimeout = setTimeout(() => {
      if (imageRefs.current[0]) {
        ...
        // Start the animation
        firstImage.style.transition = 'transform 7s cubic-bezier(0.25, 0.1, 0.25, 1)';
    ...
    const interval = setInterval(() => {
      setCurrentImageIndex((prevIndex) => {
        ...
        if (imageRefs.current[nextIndex]) {
          ...
          // Start the animation
          setTimeout(() => {
            nextImage.style.transition = 'transform 7s cubic-bezier(0.25, 0.1, 0.25, 1)';
  ...
  Falling Upwards
          ...
          {/* Image indicators */}
          <div className="absolute bottom-10 right-0 transform -translate-x-1/2 flex space-x-2 z-20">
    ...
    <div className="max-w-3xl mx-auto text-center px-4 mb-10">
      <div className="bg-white p-8 md:p-10 rounded-2xl shadow-md border border-gray-100 hover:shadow-xl transition-all duration-500">
        <p className="text-lg sm:text-xl text-gray-800 leading-relaxed">
          <span className="font-medium text-[#0B4073]">Falling Upwards</span> exists to help individuals and organisations define a vision and direction shaped by who they truly are and what they value. The only certainty in life is that we move forwards. If we're lucky, we have around <span className="font-semibold text-[#0B4073]">3 billion seconds</span> on this earth to make that journey count.
        </p>
...
<section className="section bg-white relative overflow-hidden py-20 border-t border-b border-[#D6E2EA]/30">
  <div className="container-custom mx-auto relative z-10 px-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div className="flex flex-col items-center bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl">
        <Link href="/our-services/digital-evolution" className="group w-full">
          ...
          <div className="p-6 bg-white">
            <h3 className="text-center font-medium text-gray-800 text-lg">Digital Evolution & AI Adoption</h3>
          </div>
        </Link>
      </div>
      ...
      <div className="flex flex-col items-center bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-xl">
        <Link href="/our-services/executive-mentoring" className="group w-full">
          <div className="w-full aspect-square relative overflow-hidden">
            <Image 
    ...
    <div className="text-center mt-12">
      ...
      <section className="section bg-[#7094B7] py-16">
      ...
      <section className="section bg-[#F0F5F8] py-24 md:py-32">
        <div className="container-custom mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-6xl font-bold mb-6 text-[#0B4073]">Who we have worked with</h2>
