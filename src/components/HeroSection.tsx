...
export function HeroSection({
  ...
  return (
    <section className={`relative ${heightClass[height]} flex items-center overflow-hidden`}>
      ...
      {/* Content */}
      <div className={`container-custom  relative z-10 mx-20 top-[140px] ${positionClass[textPosition]}`}>
        <div className="space-y-6 max-w-4xl mx-0">
          <h1 className={`text-3xl md:text-5xl  font-bold text-${textColor} font-roboto`}>
            {title}
          </h1>
