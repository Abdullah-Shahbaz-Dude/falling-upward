        ...
        <Container style={containerStyle}>
          ...
          <Section style={footerStyle}>
            <Text style={footerTextStyle}>
              This is an automated message from Falling Upward. Please do not reply directly to this email.
            </Text>
            <Text style={footerTextStyle}>
              © {new Date().getFullYear()} Falling Upward. All rights reserved.
            </Text>
            <Text style={footerLinksStyle}>
              <Link href="https://fallingupward.co.uk" style={footerLinkStyle}>Website</Link> • 
              <Link href="https://fallingupward.co.uk/privacy-policy" style={footerLinkStyle}>Privacy Policy</Link> • 
              <Link href="https://fallingupward.co.uk/contact" style={footerLinkStyle}>Contact Us</Link>
            </Text>
          </Section>
        </Container>
      </Body>
